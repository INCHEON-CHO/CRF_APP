"""
Mask R-CNN
Train on the toy person dataset and implement color splash effect.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 person.py train --dataset=/path/to/person/dataset --weights=coco

    # Resume training a model that you had trained earlier
    python3 person.py train --dataset=/path/to/person/dataset --weights=last

    # Train a new model starting from ImageNet weights
    python3 person.py train --dataset=/path/to/person/dataset --weights=imagenet

    # Apply color splash to an image
    python3 person.py splash --weights=/path/to/weights/file.h5 --image=<URL or path to file>

    # Apply color splash to video using the last weights you trained
    python3 person.py splash --weights=last --video=<URL or path to file>
"""
...
class personDataset(utils.Dataset):
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        """
        # If not a person dataset image, delegate to parent class.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/person/dataset/",
